	...
	<div class="row">
		<div class="large-12 columns">
			...
			<center>
				...
				<a href="addplan3.php"><div class="button radius large success">Upload from Link</div></a>
			</center>
		</div>
	</div>
	<div class="row">
		<div class="large-12 columns">
			<div class="panel">
			<form id="f" name="f" action="addplan3.php" method="post">
				<div class="row">
			      <div class="large-4 columns">
			      	<label><h5>Link to Plan</h5></label>
        			<input type="text" id="link" name="link" placeholder="Full link">
        		  </div>
        		</div>
				<div class="row">
			      <div class="large-4 columns">
